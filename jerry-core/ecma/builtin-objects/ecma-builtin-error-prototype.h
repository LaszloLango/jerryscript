...
ecma_value_t ecma_builtin_error_prototype_dispatch_call (const ecma_value_t *, ecma_length_t);
ecma_value_t ecma_builtin_error_prototype_dispatch_construct (const ecma_value_t *, ecma_length_t);
