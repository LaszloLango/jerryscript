...
ecma_builtin_math_property_descriptor_list[] =
{
  { LIT_MAGIC_STRING_E_U,
    ...
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_E }
  },
  { LIT_MAGIC_STRING_LN10_U,
    ECMA_BUILTIN_PROPERTY_NUMBER,
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_LN10 }
  },
  { LIT_MAGIC_STRING_LN2_U,
    ECMA_BUILTIN_PROPERTY_NUMBER,
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_LN2 }
  },
  { LIT_MAGIC_STRING_LOG2E_U,
    ECMA_BUILTIN_PROPERTY_NUMBER,
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_LOG2E }
  },
  { LIT_MAGIC_STRING_LOG10E_U,
    ECMA_BUILTIN_PROPERTY_NUMBER,
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_LOG10E }
  },
  { LIT_MAGIC_STRING_PI_U,
    ECMA_BUILTIN_PROPERTY_NUMBER,
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_PI }
  },
  { LIT_MAGIC_STRING_SQRT1_2_U,
    ECMA_BUILTIN_PROPERTY_NUMBER,
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_SQRT_1_2 }
  },
  { LIT_MAGIC_STRING_SQRT2_U,
    ECMA_BUILTIN_PROPERTY_NUMBER,
    ECMA_PROPERTY_FIXED,
    { .value = ECMA_BUILTIN_NUMBER_SQRT2 }
  },
