...
ecma_builtin_date_prototype_property_descriptor_list[] =
{
  ...
  { LIT_MAGIC_STRING_VALUE_OF_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_TIME } },
  { LIT_MAGIC_STRING_GET_TIME_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_TIME } },
  { LIT_MAGIC_STRING_GET_FULL_YEAR_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_FULL_YEAR } },
  { LIT_MAGIC_STRING_GET_UTC_FULL_YEAR_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_FULL_YEAR } },
  { LIT_MAGIC_STRING_GET_MONTH_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_MONTH } },
  { LIT_MAGIC_STRING_GET_UTC_MONTH_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_MONTH } },
  { LIT_MAGIC_STRING_GET_DATE_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_DATE } },
  { LIT_MAGIC_STRING_GET_UTC_DATE_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_DATE } },
  { LIT_MAGIC_STRING_GET_DAY_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_DAY } },
  { LIT_MAGIC_STRING_GET_UTC_DAY_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_DAY } },
  { LIT_MAGIC_STRING_GET_HOURS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_HOURS } },
  { LIT_MAGIC_STRING_GET_UTC_HOURS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_HOURS } },
  { LIT_MAGIC_STRING_GET_MINUTES_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_MINUTES } },
  { LIT_MAGIC_STRING_GET_UTC_MINUTES_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_MINUTES } },
  { LIT_MAGIC_STRING_GET_SECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_SECONDS } },
  { LIT_MAGIC_STRING_GET_UTC_SECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_SECONDS } },
  { LIT_MAGIC_STRING_GET_MILLISECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_MILLISECONDS } },
  { LIT_MAGIC_STRING_GET_UTC_MILLISECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_MILLISECONDS } },
  { LIT_MAGIC_STRING_GET_TIMEZONE_OFFSET_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_UTC_TIMEZONE_OFFSET } },
  { LIT_MAGIC_STRING_SET_TIME_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (1)), { ECMA_DATE_PROTOTYPE_SET_TIME } },
  { LIT_MAGIC_STRING_SET_MILLISECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (1)), { ECMA_DATE_PROTOTYPE_SET_MILLISECONDS } },
  { LIT_MAGIC_STRING_SET_UTC_MILLISECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (1)), { ECMA_DATE_PROTOTYPE_SET_UTC_MILLISECONDS } },
  { LIT_MAGIC_STRING_SET_SECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (2)), { ECMA_DATE_PROTOTYPE_SET_SECONDS } },
  { LIT_MAGIC_STRING_SET_UTC_SECONDS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (2)), { ECMA_DATE_PROTOTYPE_SET_UTC_SECONDS } },
  { LIT_MAGIC_STRING_SET_MINUTES_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (3)), { ECMA_DATE_PROTOTYPE_SET_MINUTES } },
  { LIT_MAGIC_STRING_SET_UTC_MINUTES_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (3)), { ECMA_DATE_PROTOTYPE_SET_UTC_MINUTES } },
  { LIT_MAGIC_STRING_SET_HOURS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (4)), { ECMA_DATE_PROTOTYPE_SET_HOURS } },
  { LIT_MAGIC_STRING_SET_UTC_HOURS_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (4)), { ECMA_DATE_PROTOTYPE_SET_UTC_HOURS } },
  { LIT_MAGIC_STRING_SET_DATE_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (1)), { ECMA_DATE_PROTOTYPE_SET_DATE } },
  { LIT_MAGIC_STRING_SET_UTC_DATE_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (1)), { ECMA_DATE_PROTOTYPE_SET_UTC_DATE } },
  { LIT_MAGIC_STRING_SET_MONTH_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (2)), { ECMA_DATE_PROTOTYPE_SET_MONTH } },
  { LIT_MAGIC_STRING_SET_UTC_MONTH_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (2)), { ECMA_DATE_PROTOTYPE_SET_UTC_MONTH } },
  { LIT_MAGIC_STRING_SET_FULL_YEAR_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (3)), { ECMA_DATE_PROTOTYPE_SET_FULL_YEAR } },
  { LIT_MAGIC_STRING_SET_UTC_FULL_YEAR_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (3)), { ECMA_DATE_PROTOTYPE_SET_UTC_FULL_YEAR } },
  { LIT_MAGIC_STRING_TO_UTC_STRING_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_TO_UTC_STRING } },
  { LIT_MAGIC_STRING_TO_ISO_STRING_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_TO_ISO_STRING } },
  { LIT_MAGIC_STRING_TO_JSON_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (1)), { ECMA_DATE_PROTOTYPE_TO_JSON } },
  { LIT_MAGIC_STRING_GET_YEAR_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_GET_YEAR } },
  { LIT_MAGIC_STRING_SET_YEAR_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (1)), { ECMA_DATE_PROTOTYPE_SET_YEAR } },
  { LIT_MAGIC_STRING_TO_GMT_STRING_UL, ECMA_BUILTIN_PROPERTY_ROUTINE, (ECMA_PROPERTY_FLAG_CONFIGURABLE | ECMA_PROPERTY_FLAG_WRITABLE | ECMA_SET_ROUTINE_LENGTH (0)), { ECMA_DATE_PROTOTYPE_TO_UTC_STRING } },
