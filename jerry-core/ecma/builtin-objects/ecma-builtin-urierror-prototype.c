...
{
{ LIT_MAGIC_STRING_CONSTRUCTOR, ECMA_BUILTIN_PROPERTY_OBJECT, ECMA_PROPERTY_CONFIGURABLE_WRITABLE, { .value = ECMA_BUILTIN_ID_URI_ERROR } },
{ LIT_MAGIC_STRING_NAME, ECMA_BUILTIN_PROPERTY_STRING, ECMA_PROPERTY_CONFIGURABLE_WRITABLE, { .value = LIT_MAGIC_STRING_URI_ERROR_UL } },
